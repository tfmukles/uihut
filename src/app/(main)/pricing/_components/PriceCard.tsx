...
function PriceCard({
  ...
  const isB2B = package_name.toLowerCase().includes("b2b");
  ...
  // Set the selected package from local storage
  useEffect(() => {
    setSelectedPackage(
  ...
  return isAnimated ? (
      ...
      >
        <div className="card-bg rounded-2xl">
          <div className="relative overflow-hidden p-4 lg:p-6 xl:p-[30px]">
            <div>
              <div className="absolute -right-11 top-[21px] w-[180px] rotate-45 whitespace-nowrap bg-success px-6 py-1 pl-[38px] text-center text-sm text-text-dark">
                Most Popular
              </div>
              <BlurSvg
    ...
    <div className="col mb-6">
      <div className="card-bg h-full rounded-2xl border border-border">
        <div className="relative overflow-hidden p-4 lg:p-6 xl:p-[30px]">
          <div className="relative">
            <PriceCardContent />
          </div>
